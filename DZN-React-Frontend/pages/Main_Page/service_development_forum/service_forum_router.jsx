...
import Service_forum_writing from "./service_forum_wiriting";
import Service_forum_update from './service_forum_update';
  ...
  return (
    <React.Fragment>
      ...
      <Switch>
        ...
        <Route
          exact
          path="/forum/service/content/:id"
          component={Service_forum_content}
        ></Route>
              <Route
          exact
          path="/forum/service/update/:id"
          component={Service_forum_update}
        ></Route>
        <Route
          exact
          path="/forum/service/write"
          component={Service_forum_writing}
        ></Route>
        <Route
