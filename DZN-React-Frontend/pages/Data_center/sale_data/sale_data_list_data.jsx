          ...
          list && list.map((listItem, idx) => {
              ...
              return (
                <div id='listcls' className="purchase_create_data_list_border_wrap clearfix" key={listItem.pdbase_idx}>
                  <Link to={{pathname: listItem.stat !== '0' ? `/datacenter/saledata/control/${listItem.pdbase_idx}` : '' }}>
                      ...
                      <div className="purchase_create_data_list_data_type purchase_create_data_list_data_data">
                        {
                          ...
                          <div><img src={production_activity2} alt='statistics_icon' /><p>통계</p></div>
                          || listItem.data_Type === 'M' &&
                          <div><img src={model} alt='model_icon' /><p>모델</p></div>
                          || listItem.data_Type === 'R' &&
                          <div><img src={report} alt='report_icon' /><p>리포트</p></div>
                        }
                      </div>
                    </div>
                  </Link>
...

                    {
                      ...
                      || listItem.stat !== '0' && (
                        ...
                        <div className="purchase_create_data_list_data_btn_wrap">
                          <Link to={{pathname: `/datacenter/saledata/control/${listItem.pdbase_idx}`}}>
                            <button>입력</button>
                          </Link>
                          <button
                            id={`delete_btn_${listItem.pdbase_idx}`}
