...
let dummy_data = [
  {
    date: '2020-01-29 13:48', date_title: '일반전표 (일별 매출, 매입 합산 집계 데이터)', by_user: '홍길동[wehagodev]',
    plan: '200000회 / 일', all_by: '200000', card_plan: '15000', point: '54000'
  },
  {
    date: '2020-02-29 13:48', date_title: '일반전표 (일별 매출, 매입 합산 집계 데이터)', by_user: '세종대왕[wehagodev]',
    plan: '200000회 / 일', all_by: '200000', card_plan: '25000', point: '15000'
  },
  {
    date: '2020-03-29 13:48', date_title: '일반전표 (일별 매출, 매입 합산 집계 데이터)', by_user: '홍길동[wehagodev]',
    plan: '200000회 / 일', all_by: '200000', card_plan: '35000', point: '25000'
  },
  {
    date: '2020-04-29 13:48', date_title: '일반전표 (일별 매출, 매입 합산 집계 데이터)', by_user: '세종대왕[wehagodev]',
    plan: '200000회 / 일', all_by: '200000', card_plan: '45000', point: '35000'
  },
  {
    date: '2020-05-29 13:48', date_title: '일반전표 (일별 매출, 매입 합산 집계 데이터)', by_user: '홍길동[wehagodev]',
    plan: '200000회 / 일', all_by: '200000', card_plan: '55000', point: '45000'
  },
  {
    date: '2020-06-29 13:48', date_title: '일반전표 (일별 매출, 매입 합산 집계 데이터)', by_user: '세종대왕[wehagodev]',
    plan: '200000회 / 일', all_by: '200000', card_plan: '65000', point: '55000'
  },
  {
    date: '2020-07-29 13:48', date_title: '일반전표 (일별 매출, 매입 합산 집계 데이터)', by_user: '홍길동[wehagodev]',
    plan: '200000회 / 일', all_by: '200000', card_plan: '75000', point: '65000'
  },
  {
    date: '2020-08-29 13:48', date_title: '일반전표 (일별 매출, 매입 합산 집계 데이터)', by_user: '세종대왕[wehagodev]',
    plan: '200000회 / 일', all_by: '200000', card_plan: '85000', point: '75000'
  },
  {
    date: '2020-09-29 13:48', date_title: '일반전표 (일별 매출, 매입 합산 집계 데이터)', by_user: '홍길동[wehagodev]',
    plan: '200000회 / 일', all_by: '200000', card_plan: '95000', point: '85000'
  },
  {
    date: '2020-09-29 13:48', date_title: '일반전표 (일별 매출, 매입 합산 집계 데이터)', by_user: '세종대왕[wehagodev]',
  ...
  {
    date: '2020-09-23 13:48', date_title: '일반전표 (일별 매출, 매입 합산 집계 데이터)', by_user: '세종대왕2[wehagodev',
    plan: '200000회 / 일', all_by: '200000', card_plan: '129000', point: '105000'
  },
  {
    date: '2020-12-21 13:48', date_title: '일반전표 (일별 매출, 매입 합산 집계 데이터)', by_user: '세종대왕3[wehagodev]',
    plan: '200000회 / 일', all_by: '200000', card_plan: '125000', point: '105000'
  },
  {
    date: '2020-09-21 13:48', date_title: '일반전표 (일별 매출, 매입 합산 집계 데이터)', by_user: '세종대왕3[wehagodev]',
    plan: '200000회 / 일', all_by: '200000', card_plan: '195000', point: '105000'
  },
  {
    date: '2020-07-21 13:48', date_title: '일반전표 (일별 매출, 매입 합산 집계 데이터)', by_user: '세종대왕3[wehagodev]',
    plan: '200000회 / 일', all_by: '200000', card_plan: '125000', point: '105000'
  },
]
...
const Profile_Table = () => {
  ...
  return (
    <React.Fragment>
      ...
      />
      <div className="Sales_calculate_info_table_box">
        <Table responsive>
          <caption className="tb_caption">
            ...
            <div className="tb_select_wrap">
              <Excel_download Download_data={csvData} File_name={"데이터 매출분석"} />
              <Form.Control
                as="select"
                ...
                {search_yn_state === false
                  ? sales_post_data.map((result) => {
                      return (
                        <tr>
                          <td>{result.date}</td>
                          <td>{result.date_title}</td>
                          <td>{result.by_user}</td>
                          <td>{result.plan}</td>
                          <td>{result.all_by}</td>
