...
const Basic_info = (props) => {
  ...
  useEffect(() => {
    const getDataGbnCate = Server_ajax_get(
      "datacenter/getDataGbnCate"      
      
    );
    setDataGbnCateList((dataGbnCateList) => [
      ...dataGbnCateList,
      getDataGbnCate,
    ]);
    setCateLoad(true);
          ...
          <div className="exposure_info_input_wrap">
            <div className="exposure_info_input_table_wrap">
              ...
              <div className="exposure_info_input_right_wrap">
                ...
                />
                <p>
                  ※ 데이터에 대한 제목으로 요약해서 설명하는 구문으로 반드시
                  작성하셔야 합니다.
                </p>
              </div>
            </div>
              ...
              <div className="exposure_info_input_right_wrap">
                <div className="privacy_wrap">
                  <Form.Control
                    ...
                    value={mangr_name}
                    onChange={onChangeMangr_name}
                  />
                  <Form.Control
                    type="text"
                    className="form_input privacy_phone_number "
                    placeholder="전화번호를 입력하세요."
                    value={mangr_tel}
                    onChange={onChangeMangr_tel}
                  />
                  <Form.Control
                    type="text"
                    className="form_input privacy_email"
                    placeholder="이메일 입력하세요."
                    value={mangr_email_1}
                    onChange={onChangeMangr_email_1}
                  />
                  <div>@</div>
                  <input
                    ref={mangr_email_input}
                    list="email_address"
                    className="privacy_email_address"
                    name="email_address"
                    value={mangr_email_2}
                    onChange={onChangeMangr_email_2}
                    onSelect={onSelectMangr_email_sample}
                  />
              ...
              <div className="exposure_info_input_right_wrap">
                <div className="privacy_wrap">
                  ...
                  <Form.Control
                    ...
                    placeholder="전화번호를 입력하세요."
                    value={creatr_tel}
                    onChange={onChangeCreatr_tel}
                  />
                  <Form.Control
                    type="text"
                    className="form_input privacy_email"
                    placeholder="이메일 입력하세요."
                    value={creatr_email_1}
                    onChange={onChangeCreatr_email_1}
                  />
                  <div>@</div>
                  <input
                    list="email_address"
                    className="privacy_email_address"
                    name="email_address"
                    value={creatr_email_2}
                    onChange={onChangeCreatr_email_2}
                    onSelect={onSelectCreatr_email_sample}
                  />
                  <datalist id="email_address">
                    <option value="직접입력" />
                    <option value="naver.com" />
                ...
                <Form.Control
                  type="text"
                  className="form_input"
                  placeholder="홈페이지 주소입력(예:https://"
                  value={creatr_url}
                  onChange={onChangeCreatr_url}
                />
              ...
              <div className="exposure_info_input_right_wrap">
                <div className="privacy_wrap">
                  ...
                  <Form.Control
                    ...
                    placeholder="전화번호를 입력하세요."
                    value={regstr_tel}
                    onChange={onChangeRegstr_tel}
                  />
                  <Form.Control
                    type="text"
                    className="form_input privacy_email"
                    placeholder="이메일 입력하세요."
                    value={regstr_email_1}
                    onChange={onChangeRegstr_email_1}
                  />
                  <div>@</div>
                  <input
                    list="email_address"
                    className="privacy_email_address"
                    name="email_address"
                    value={regstr_email_2}
                    onChange={onChangeRegstr_email_2}
                    onSelect={onSelectRegstr_email_sample}
                  />
                  <datalist id="email_address">
                    <option value="직접입력" />
                    <option value="naver.com" />
            ...
            <div className="exposure_info_input_table_wrap">
              ...
              <div className="exposure_info_input_right_wrap">
                <Form.Control
                  as="textarea"
                  rows="5"
                  placeholder="데이터에 대한 설명으로 반드시 상세히 작성하셔야 합니다."
                  value={data_desc}
                  onChange={onChangeData_desc}
                />
              </div>
            </div>
            <div className="exposure_info_input_table_wrap">
              ...
              <div className="exposure_info_input_right_wrap">
                <Form.Control
                  type="text"
                  className="form_input"
                  placeholder="dataset의 사용언어와 동일하게 입력하세요."
                  value={data_Lang}
                  onChange={onChangeData_Lang}
                />
              </div>
            </div>
            <div className="exposure_info_input_table_wrap">
            ...
            <div className="exposure_info_input_table_wrap">
              ...
              <div className="exposure_info_input_right_wrap">
                <Form.Control
                  type="text"
                  className="form_input"
                  placeholder="https://developers.wehago.com/"
                  value={landingPage}
                  onChange={onChangeLandingPages}
                />
                <p>
                  ※ 홈페이지 URL 정보로 이동하여 상세 정보를 열람할 수 있습니다.
                </p>
              </div>
            </div>
            <div className="exposure_info_input_table_wrap">
              ...
              <div className="exposure_info_input_right_wrap">
                <Form.Control
                  type="text"
                  className="form_input"
                  placeholder="라이선스 관련 문구, 특별한 양식 없이 자유 서식이며, 법적인 권리 관계를 설명합니다. (예: by CC)"
                  value={license}
            ...
            <div className="exposure_info_input_table_wrap">
              ...
              <div className="exposure_info_input_right_wrap">
                <Form.Control
                  type="text"
                  className="form_input"
                  placeholder="Copyright를 입력하세요.(예: Copyright 2020. 더존비즈온)"
                  value={copyright}
