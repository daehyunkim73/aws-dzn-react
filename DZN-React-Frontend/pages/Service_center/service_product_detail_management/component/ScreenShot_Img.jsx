...
import { FileNameChange, FileRemove } from "../../../../src/Image_Preview";
        ...
        <div className="Sales_info_sc_right_wrap Sales_info_sc_right_upload_wrap">
          <div className="Sales_info_sc_right_first_wrap">
            ...
            <input
              ...
              defaultValue={!val === false ? val.scrsht_title : undefined}
              name={"Sales_img_" + index + "title"}
            />
          </div>
          <div className="Sales_info_sc_right_second_wrap">
            ...
            <textarea
              ...
              defaultValue={!val === false ? val.scrsht_desc : undefined}
              name={"Sales_img_" + index + "content"}
            ></textarea>
          </div>
        </div>
      </div>
