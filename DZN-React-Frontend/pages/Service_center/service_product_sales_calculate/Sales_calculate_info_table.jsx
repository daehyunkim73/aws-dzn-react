...
const Sales_calculate_info_table = () => {
  const test = useRef();
    ...
    <React.Fragment>
      ...
      <div className="Sales_calculate_info_table_box">
        <Table responsive>
          ...
          {(search_yn_state === false && sales_post_data.length !== 0) ||
...
export default Sales_calculate_info_table;
