...
const Service_Title_popup_v2 = () => {
    const Image_close_popup = useCallback(() => {
        const ServiceCenter_title_popup_bgk_v2 = document.getElementById("ServiceCenter_title_popup_bgk_v2");
        ServiceCenter_title_popup_bgk_v2.style.display = "none";
    }, []);

    return (
        <React.Fragment>
            <div className="smae_popup_bgk_big_box" id="ServiceCenter_title_popup_bgk_v2">
...
export default Service_Title_popup_v2;