...
const Account_uploade_error= () => {
    const Image_close_popup = useCallback(() => {
        const Account_uploade_error_bgk = document.getElementById("Account_uploade_error_bgk");
        Account_uploade_error_bgk.style.display = "none";
    }, []);
    return (
        <React.Fragment>
             <div className="smae_popup_bgk_big_box" id="Account_uploade_error_bgk">
...
export default Account_uploade_error;