...
} from "../func_src/Same_next_post_pagenation";
...
export function Roo_pagenation(page_oper_num, page_all_gaci, gaci_post, func_gaci_post, gaci_page_nation_num, func_page_nation_num, yn_state, search_date_state) {
        ...
        <div className="pagination_btn_wrap">
          ...
          {yn_state === false
            ...
            search_date_state.map((search_list_v, search_list_i) => {
              if (search_list_i < search_date_state.length / Number(oper_page_num)) {
                search_list_i++;
                return (
                  <Pagenation_link
