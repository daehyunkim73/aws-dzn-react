...
const update_header = ({setRending, searchData, setSearchData}) => {
    const onKeyPress = (e) => {
        if(e.key == 'Enter') {
          searchCilck();
        }
        ...
        <React.Fragment>
            ...
            <div className="Notice_from_wrap">
                ...
                <div className="faq_input_form" id="Notice_input_box">
                    <Form.Control type="text" placeholder="검색할 업데이트 게시판의 제목을 입력해주세요." onChange={inputChange} onKeyPress={onKeyPress}/>
                </div>
            </div>
