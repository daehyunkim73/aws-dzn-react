...
const Sales_Service_management_search = ({setRending, searchData, setSearchData}) => {
        // 기본 검색 정보
        useEffect(() => {
            setSearchData({
                searchDateType: '0'
                    ...
                    <div className="search_wrap">
                        ...
                        <div className="search_form_wrap">
                            ...
                            <div className="input_form" id="search_df_ct_pr">
                                <Form.Control type="text" className="form_input" placeholder="서비스 제목,회원명,아이디를 검색하세요." onChange={inputChange} />
                            </div>
                        </div>
                    </div>
...
export default Sales_Service_management_search;
