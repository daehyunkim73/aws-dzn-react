...
const Pagination_ui = (props) => {
  ...
  useEffect(() => {
      ...
      //setTotalPageArr(totalPageArr=> [...totalPageArr, _.range(startPageNum, endPageNum+1)]);   //Error
      setTotalPageArr(_.range(startPageNum, endPageNum + 1));
      
      //console.log('typeof totalPageArr', typeof totalPageArr),
      console.log('toString.call(totalPageArr)', toString.call(totalPageArr)),
      console.log('totalPageArr.length', totalPageArr.length);
      console.log('startPageNum', startPageNum);
      console.log('endPageNum', endPageNum);
      console.log('totalPageArr', totalPageArr);
      console.log('totalPageCount', totalPageCount);
      console.log('currPage', currPage);
      console.log('ttlRowsCnt', ttlRowsCnt);
  },
  [currPage, startPageNum, endPageNum, ttlRowsCnt])
