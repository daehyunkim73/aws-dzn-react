...
import CommonDataManagementBasicInfo from './components/Common_Data_management/common_data_management_basic/common_data_management_basic_info';
import CommonDataSaleMain from './components/Common_Data_management/common_data_management_sale/common_data_sale_main';
import CommonDataManagementJudge from './components/Common_Data_management/common_data_management_judge/common_data_management_judge';
import CommonDataSalesManagementInfo from './components/Common_Data_management/common_data_sales_management_info/common_data_sales_management_info'
            ...
            <div className="Data_Approved_management_wrap">
                ...
                <Tabs className="backoffice_tab_wrap" defaultActiveKey="basic" id="uncontrolled-tab-example">
                    <Tab eventKey="basic" title="기본정보" className="Data_Approved_management_basic_tab_wrap" >
                        {loading && <CommonDataManagementBasicInfo defaultData={defaultData} /> }
                    </Tab>                    
                    <Tab eventKey="sale" className="calculate_registration Data_Approved_management_sale_tab_wrap" title="판매정보">
                        {loading && <CommonDataSaleMain defaultData={defaultData} salesState={salesState} setSalesState={setSalesState}/>}
                    </Tab>                    
                    {loading && salesState && salesState !== '' && 
                    <Tab eventKey="sales" className="calculate_registration" title="매출 정보">
                        <CommonDataSalesManagementInfo />
                    </Tab>
                    }
                    <Tab eventKey="judge" className="calculate_registration" title="승인 심사">
                        {loading && <CommonDataManagementJudge defaultData={defaultData} state={state} setState={setState} />}
                    </Tab>
                </Tabs>
