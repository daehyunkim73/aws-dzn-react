...
const Sales_data_management_list_search = ({setRending, searchData, setSearchData}) => {
                        ...
                        <div className="search_form_wrap">
                            <div className="input_form white_border" id="date_picker_sp_box">
                                <select className="search_date_select form-control" onChange={dateTypeChange}>
                                    <option value="0">판매게시일</option>
                                    <option value="1">최종수정일</option>
                                </select>
                            ...
                            <div className="input_form" id="search_df_ct_pr">
                                <Form.Control type="text" className="form_input" placeholder="데이터 제목,회원명,아이디를 검색하세요." onChange={inputChange} />
                            </div>
                        </div>
                    </div>
...
export default Sales_data_management_list_search;
