...
const Service_forum_main = () => {
  const [key, setKey] = useState("home");
  const [forum, Setforum] = useState("서비스 개발자 포럼");
    ...
    <React.Fragment>
      <div className="forum_main_box">
        ...
        <Tabs
          ...
          onSelect={(k) => setKey(k)}
        >
          <Tab eventKey="data_forum" title="데이터 개발자 포럼">
            <Data_forum_header />
            <Data_forum_table />
            <Pagination />
          </Tab>
          <Tab eventKey="home" title="서비스 개발자 포럼">
...
export default Service_forum_main;
