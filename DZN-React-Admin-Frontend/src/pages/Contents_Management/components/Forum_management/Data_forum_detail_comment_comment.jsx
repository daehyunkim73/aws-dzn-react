...
const Data_forum_detail_comment_comment = () => {
    const [Data_admin_data_froum_value_v2, Set_data_froum_value_v2] = useState(0);
                        ...
                        <div className="admin_post_comment_input_real_box">
                            ...
                            <div className="admin_value_input_comment_box">
                                <div className="admin_number_input_text_upBox">
                                    <p><span id="max_number_gaci">{Data_admin_data_froum_value_v2}</span>
                                        <span>/</span>
                                        <span>200</span></p>
                                </div>
                    ...
                    <div className="admin_comment_many_box">
                        ...
                        <div className="admin_comment_contents_box">
                            ...
                            <div className="admin_comment_comment_date_time_box forum_comments_delete_button_box">
                                <button className="data_post_comments_uploade_btn">답글</button>
                                <button className="data_post_comments_delete_btn">삭제</button>
                                <p>12분전</p>
                            </div>
                        </div>
                    </div>
...
export default Data_forum_detail_comment_comment;