...
const Data_sales_management_search = ({
  setSearchData,
  setRending,
  setIsSearch,
}) => {
  ...
  const searchClick = () => {
    ...
    setSearchData((data) => {
      return { ...data, startDate: startDate.value, endDate: endDate.value };
    });
...
export default Data_sales_management_search;
