...
const Upadte_posts_posts_uploade_popup = ({setConfirm}) => {
    ...
    return (
        <React.Fragment>
            <div className="admin_background_same_box" id="Admin_user_update_post_uplaode_popup_bgk">
...
export default Upadte_posts_posts_uploade_popup;