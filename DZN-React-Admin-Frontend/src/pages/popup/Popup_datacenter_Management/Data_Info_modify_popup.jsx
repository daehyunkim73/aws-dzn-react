...
const Data_Info_modify_popup = () => {
    const Image_close_popup = useCallback(() => {
        const Admin_user_Data_info_modify_popup_bgk = document.getElementById("Admin_user_Data_info_modify_popup_bgk");
        Admin_user_Data_info_modify_popup_bgk.style.display = "none";
    }, []);
    return (
        <React.Fragment>
            <div className="admin_background_same_box" id="Admin_user_Data_info_modify_popup_bgk">
...
export default Data_Info_modify_popup;