...
const Data_center_exposure_popup_v2 = ({ setShowGbnStat }) => {
  ...
  const Image_close_popup = useCallback(() => {
    ...
    Admin_user_datacenter_mang_popup_bgk_v2.style.display = "none";
  }, []);
  ...
  return (
    <React.Fragment>
      <div
        ...
        id="Admin_user_datacenter_mang_popup_bgk_v2"
      >
...
export default Data_center_exposure_popup_v2;
