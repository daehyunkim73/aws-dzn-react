...
const Notice_posts_delete_popup = () => {
    const Image_close_popup = useCallback(() => {
        const Admin_user_noticeDelete_popup_bgk = document.getElementById("Admin_user_noticeDelete_popup_bgk");
        Admin_user_noticeDelete_popup_bgk.style.display = "none";
    }, []);
    return (
        <React.Fragment>
            <div className="admin_background_same_box" id="Admin_user_noticeDelete_popup_bgk">
                    ...
                    <div className="admin_small_white_box">
                        ...
                        <div className="admin_big_contents_box">
                            ...
                            <button className="admin_popup_first_btn" onClick={Image_close_popup}>취소</button>
                                <button className="admin_popup_second_btn" id="notice_gaci_delete_btn">확인</button>
                            </div>
                        </div>
                    </div>
                </div>
...
export default Notice_posts_delete_popup;