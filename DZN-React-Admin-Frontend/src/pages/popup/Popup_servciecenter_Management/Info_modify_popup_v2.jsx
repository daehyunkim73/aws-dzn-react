...
const Info_modify_popup_v2 = () => {
    const Image_close_popup = useCallback(() => {
        const Admin_user_info_modify_v2_popup_bgk = document.getElementById("Admin_user_info_modify_v2_popup_bgk");
        Admin_user_info_modify_v2_popup_bgk.style.display = "none";
    }, []);
    return (
        <React.Fragment>
            <div className="admin_background_same_box" id="Admin_user_info_modify_v2_popup_bgk">
...
export default Info_modify_popup_v2;