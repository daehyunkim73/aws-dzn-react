...
} from "../../func_src/Same_page_nation";
...
export function Roo_pagenation(page_all_gaci, gaci_post, func_gaci_post, gaci_page_nation_num, func_page_nation_num, yn_state, search_date_state, cnt) {
          ...
          if (
            ...
            if (page_nation_state === "big_next_nation") {
              search_date_state.map((v, i) => {
                setNumber_array([]);
                if (i < search_date_state.length / cnt) {
                  i++;
        ...
        <div className="pagination_btn_wrap">
          ...
          {yn_state === false
            ...
            search_date_state.map((search_list_v, search_list_i) => {
              if (search_list_i < search_date_state.length / cnt) {
                search_list_i++;
                return (
                  <Pagenation_link
