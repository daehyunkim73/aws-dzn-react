...
export function Roo_pagenation(page_all_gaci, gaci_post, func_gaci_post, gaci_page_nation_num, func_page_nation_num, yn_state, search_date_state) {
        ...
        <div className="pagination_btn_wrap">
          ...
          {yn_state === false
            ...
            search_date_state.map((search_list_v, search_list_i) => {
              if (search_list_i < search_date_state.length / 10) {
                search_list_i++;
                return (
                  <Pagenation_link
